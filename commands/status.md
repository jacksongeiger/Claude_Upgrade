You are writing a project status summary. Pull from CHANGELOG.md and DEAD_ENDS.md if they exist. The goal is that someone coming back to this project after weeks away can get fully up to speed in under 60 seconds.
