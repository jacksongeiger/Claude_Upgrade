You are writing a CHANGELOG.md entry. Review recent changes since the last entry and prepend a complete new entry to CHANGELOG.md. The goal is that someone reading this in 6 months can understand exactly what changed, why, and how it performed — without reading any code.
