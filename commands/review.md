You are performing a thorough code review. Work through these passes in order. Fix anything straightforward. Flag anything that needs a decision from the user.
